      ...
      <div className="container relative">
        ...
        <div className="flex justify-center mt-8">
          <div className="inline-flex relative">
            ...
            <Image src={cursorImage} alt="cursor image" height={200} width={200} className="absolute right-[476px] top-[108px] hidden sm:inline"/>
            <Image src={messageImage} alt="message image" height={200} width={200} className="absolute left-[498px] top-[56px] hidden sm:inline"/>
          </div>
        </div>
